<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index2.aspx.cs" Inherits="ProjectHMS.Index2" %>
              ...
              <img src="DDU.jpg"/>
               ...
               <h1> DDU BOY'S HOSTEL</h1>
                  <%-- <%--&nbsp&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
                   <a href="" >Login</a>--%>
                   <button type='button'  id="btn1" runat="server" onserverclick="btn1_ServerClick">LOGIN</button>
                   <button type='button' runat="server" onserverclick="btn2_ServerClick" id="btn2">SIGN UP</button>
